...
declare module "godot" {
    ...
    class EditorHelp<Map extends Record<string, Node> = Record<string, Node>> extends VBoxContainer<Map> {
        constructor(identifier?: any)
    ...
    class EditorHelpBitTooltip<Map extends Record<string, Node> = Record<string, Node>> extends PopupPanel<Map> {
        constructor(identifier?: any)
    }
    ...
    class EditorPropertyEasing<Map extends Record<string, Node> = Record<string, Node>> extends EditorProperty<Map> {
        constructor(identifier?: any)
    }
    ...
    class EditorPropertyVector3<Map extends Record<string, Node> = Record<string, Node>> extends EditorPropertyVectorN<Map> {
        constructor(identifier?: any)
    }
    ...
    class FindBar<Map extends Record<string, Node> = Record<string, Node>> extends HBoxContainer<Map> {
        constructor(identifier?: any)
    }
    ...
    /** @link https://docs.godotengine.org/en/latest/classes/class_gdbrowserview.html */
    class GDBrowserView<Map extends Record<string, Node> = Record<string, Node>> extends Node<Map> {
        constructor(identifier?: any)
        close(): void
        id(): int64
        get_error(): string
        is_valid(): boolean
        set_zoom_level(_unnamed_arg0: float64): void
        get_title(): string
        get_url(): string
        load_url(_unnamed_arg0: string): void
        load_data_uri(_unnamed_arg0: string, _unnamed_arg1: string): void
        download_file(_unnamed_arg0: string): void
        allow_downloads(_unnamed_arg0: boolean): void
        set_download_folder(_unnamed_arg0: string): void
        is_loaded(): boolean
        reload(): boolean
        stop_loading(): void
        copy(): void
        ...
        execute_javascript(_unnamed_arg0: string): void
        has_previous_page(): boolean
        has_next_page(): boolean
        previous_page(): void
        next_page(): void
        resize(_unnamed_arg0: Vector2): void
        set_viewport(_unnamed_arg0: float64, _unnamed_arg1: float64, _unnamed_arg2: float64, _unnamed_arg3: float64): boolean
        set_key_pressed(_unnamed_arg0: int64, _unnamed_arg1: boolean, _unnamed_arg2: boolean, _unnamed_arg3: boolean, _unnamed_arg4: boolean): void
        set_mouse_moved(_unnamed_arg0: int64, _unnamed_arg1: int64): void
        set_mouse_left_click(): void
        set_mouse_right_click(): void
        set_mouse_middle_click(): void
        set_mouse_left_down(): void
        set_mouse_left_up(): void
        set_mouse_right_down(): void
        set_mouse_right_up(): void
        set_mouse_middle_down(): void
        set_mouse_middle_up(): void
        set_mouse_wheel_vertical(_unnamed_arg0: int64): void
        set_mouse_wheel_horizontal(_unnamed_arg0: int64): void
        set_muted(_unnamed_arg0: boolean): boolean
        is_muted(): boolean
        get_pixel_color(x: int64, y: int64): Color
        register_method(_unnamed_arg0: Callable): boolean
        send_to_js(event_name: string, data: any): boolean
        add_ad_block_pattern(pattern: string): boolean
        enable_ad_block(enable: boolean): void
        is_ad_block_enabled(): boolean
        get audio_stream(): Object
        set audio_stream(value: Object)
        get texture(): Object
        set texture(value: Object)
        readonly on_download_updated: Signal3<string, int64, Object>
        readonly on_page_loaded: Signal1<Object>
        readonly on_page_failed_loading: Signal3<int64, string, Object>
        readonly on_browser_paint: Signal1<Object>
        readonly on_html_content_requested: Signal2<string, Object>
    }
    /** @link https://docs.godotengine.org/en/latest/classes/class_gdcef.html */
    class GDCef<Map extends Record<string, Node> = Record<string, Node>> extends Node<Map> {
        constructor(identifier?: any)
        initialize(config: GDictionary): boolean
        get_full_version(): string
        get_version_part(_unnamed_arg0: int64): int64
        create_browser(_unnamed_arg0: string, _unnamed_arg1: TextureRect, _unnamed_arg2: GDictionary): GDBrowserView
        shutdown(): void
        is_alive(): boolean
        get_error(): string
        invoke_js_callback(_unnamed_arg0: any): void
        readonly postMessage: Signal1<Object>
    }
    ...
    /** @link https://docs.godotengine.org/en/latest/classes/class_gdscripttextdocument.html */
    ...
    /** @link https://docs.godotengine.org/en/latest/classes/class_gdscriptworkspace.html */
    ...
    class HighlightedLabel<Map extends Record<string, Node> = Record<string, Node>> extends Label<Map> {
        constructor(identifier?: any)
    }
