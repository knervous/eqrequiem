...
declare module "godot" {
    ...
    class Camera2DEditor<Map extends Record<string, Node> = Record<string, Node>> extends Control<Map> {
        constructor(identifier?: any)
        _snap_limits_to_viewport(): void
        _undo_snap_limits_to_viewport(prev_rect: Rect2): void
    }
    class Camera2DEditorPlugin<Map extends Record<string, Node> = Record<string, Node>> extends EditorPlugin<Map> {
        constructor(identifier?: any)
    }
    namespace Camera3D {
        enum ProjectionType {
    ...
    class Camera3DPreview<Map extends Record<string, Node> = Record<string, Node>> extends TexturePreview<Map> {
        constructor(identifier?: any)
    }
    ...
    class ColorChannelSelector<Map extends Record<string, Node> = Record<string, Node>> extends HBoxContainer<Map> {
        constructor(identifier?: any)
        readonly selected_channels_changed: Signal0
    }
    ...
    class EditorAssetInstaller<Map extends Record<string, Node> = Record<string, Node>> extends ConfirmationDialog<Map> {
        constructor(identifier?: any)
    }
    ...
    class EditorAssetLibraryItem<Map extends Record<string, Node> = Record<string, Node>> extends PanelContainer<Map> {
        constructor(identifier?: any)
        set_image(_unnamed_arg0: int64, _unnamed_arg1: int64, _unnamed_arg2: Texture2D): void
        readonly asset_selected: Signal0
        readonly category_selected: Signal0
        readonly author_selected: Signal0
    }
    class EditorAssetLibraryItemDescription<Map extends Record<string, Node> = Record<string, Node>> extends ConfirmationDialog<Map> {
        constructor(identifier?: any)
        set_image(_unnamed_arg0: int64, _unnamed_arg1: int64, _unnamed_arg2: Texture2D): void
    }
    class EditorAssetLibraryItemDownload<Map extends Record<string, Node> = Record<string, Node>> extends MarginContainer<Map> {
        constructor(identifier?: any)
        readonly install_asset: Signal2<string, string>
    }
    ...
    class EditorDebuggerInspector<Map extends Record<string, Node> = Record<string, Node>> extends EditorInspector<Map> {
        ...
        readonly objects_edited: Signal4<GArray, string, any /*value*/, string>
    ...
    class EditorDebuggerRemoteObjects extends Object {
        constructor(identifier?: any)
        get_title(): string
        readonly values_edited: Signal3<string, GDictionary, string>
    }
    ...
    class EditorDebuggerTree<Map extends Record<string, Node> = Record<string, Node>> extends Tree<Map> {
        constructor(identifier?: any)
        readonly objects_selected: Signal2<GArray, int64>
        readonly selection_cleared: Signal1<int64>
