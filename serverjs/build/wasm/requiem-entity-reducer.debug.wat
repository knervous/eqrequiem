(module
 ...
 (type $2 (func (param i32 i32 i32 i32 f32 f32 f32 f32 f32) (result i32)))
 ...
 (func $../common/assembly/requiem-entity-reducer/frustumMarkSoA (param $base i32) (param $planesPtr i32) (param $visibleIndicesPtr i32) (param $visibilityPtr i32) (param $baseRadius f32) (param $cameraX f32) (param $cameraY f32) (param $cameraZ f32) (param $maxDistance f32) (result i32)
  (local $count i32)
  (local $instances i32)
