...
export interface QuestEntitySnapshot {
    ...
    readonly position?: QuestVector3 & {
...
export interface QuestEntity {
    ...
    readonly position: Readonly<QuestVector3 & {
        heading?: number;
    }> | null;
...
export type QuestHandlerContext<E extends QuestEventName = QuestEventName> = QuestEventArguments[E];
...
export interface QuestHandlerDefinition<E extends QuestEventName = QuestEventName> extends QuestHandlerOptions {
    event: E;
    /** Code-owned deterministic handler. Functions never cross a Worker boundary. */
    handler?: QuestInlineHandler<E>;
}
export type QuestInlineHandlerResult = boolean | QuestEffect | readonly QuestEffect[] | null | undefined | void;
export type QuestInlineHandler<E extends QuestEventName> = (context: QuestHandlerContext<E>) => QuestInlineHandlerResult;
...
export declare function onQuest<E extends QuestEventName>(event: E, options: QuestHandlerOptions, handler: QuestInlineHandler<E>): QuestHandlerDefinition<E>;
export declare function defineQuest<T extends QuestDefinition>(definition: T): T;
export {};
