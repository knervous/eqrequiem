...
export type PersistCommand = {
    ...
    accountId: number;
    character: import("../backend/contracts.js").BackendCharacterCreate;
} | {
...
export type PersistResult = {
    type: "login_load";
    data: PersistLoginResult;
} | {
    type: "character_create";
    data: PersistCreateCharacterResult;
} | {
    type: "character_delete";
    data: PersistDeleteCharacterResult;
} | {
    type: "inventory_move";
    data: PersistMoveItemResult;
} | {
    type: "inventory_delete";
    data: PersistDeleteItemResult;
};
