...
import { ActionButtonData, FullActionData, FullItemEntryData } from './constants';

type DropDetail<T> = { data: T; originalEvent: MouseEvent };

export function useItemDragClone<T extends HTMLElement>(
  actionData: FullItemEntryData | null = null,
) {
  ...
  const onMouseUp = useCallback(
    (e: MouseEvent) => {
      ...
      if (hotButtonElement) {
        const dropEvent = new CustomEvent<DropDetail<FullItemEntryData | null>>(
          'item-drop',
