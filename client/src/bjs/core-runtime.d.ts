...
export { Matrix, Quaternion, Vector2, Vector3, Vector4, } from '@babylonjs/core/Maths/math.vector.js';
...
export { PhysicsShapeCapsule, PhysicsShapeMesh, } from '@babylonjs/core/Physics/v2/physicsShape.js';
...
export { LoadAssetContainerAsync, SceneLoader, } from '@babylonjs/core/Loading/sceneLoader.js';
export { BasisTools, GetInternalFormatFromBasisFormat, } from '@babylonjs/core/Misc/basis.js';
