...
- Name: controls-options.spec.ts >> keyboard rebinding >> records modifier combinations
- Location: e2e/controls-options.spec.ts:61:3
...
Locator:  getByTestId('keybind-sitStand')
Expected: "Ctrl+G"
Received: "Ctrl"
Timeout:  5000ms
...
Call log:
  ...
  - waiting for getByTestId('keybind-sitStand')
    14 × locator resolved to <button class="" data-testid="keybind-sitStand">Ctrl</button>
       - unexpected value "Ctrl"
...
```ts
  1   | // File: client/e2e/controls-options.spec.ts
  2   | import { expect, test } from '@playwright/test';
  3   | import {
  4   |   connectPad,
  5   |   installVirtualGamepad,
  6   |   setPadState,
  7   |   withButtons,
  8   | } from './fixtures/virtual-gamepad';
  9   | 
  10  | const readConfig = (page: import('@playwright/test').Page) =>
  11  |   page.evaluate(() => window.controlsHarness.config());
  12  | 
